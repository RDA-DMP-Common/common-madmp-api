...
/**
* The DMP system has identified this DMP to be already present in the system based on its DMP ID or other characteristics. The error response SHOULD contain the existing DMP ID. 
*/
export class DMPAlreadyExistsError {
    'errorCode': DMPAlreadyExistsErrorErrorCodeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "DMPAlreadyExistsErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
    ...
    static getAttributeTypeMap() {
        return DMPAlreadyExistsError.attributeTypeMap;
    }
...
export enum DMPAlreadyExistsErrorErrorCodeEnum {
    DmpAlreadyExists = 'dmp_already_exists'
}
