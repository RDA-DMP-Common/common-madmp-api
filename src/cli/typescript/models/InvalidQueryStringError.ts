...
*/
export class InvalidQueryStringError {
    'errorCode': InvalidQueryStringErrorErrorCodeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "InvalidQueryStringErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
    ...
    static getAttributeTypeMap() {
        return InvalidQueryStringError.attributeTypeMap;
    }
...
export enum InvalidQueryStringErrorErrorCodeEnum {
