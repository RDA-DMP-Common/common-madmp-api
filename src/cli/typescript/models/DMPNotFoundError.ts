...
/**
* This error can mean two things: either the specified DMP does not exist, or the implementation has chosen to return a 404 error instead of a 401 or 403 to avoid leaking information about the existence of a DMP. If the requester is not authenticated, the request may be retried after authentication to possibly retrieve the DMP. 
*/
export class DMPNotFoundError {
    'errorCode': DMPNotFoundErrorErrorCodeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "DMPNotFoundErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
    ...
    static getAttributeTypeMap() {
        return DMPNotFoundError.attributeTypeMap;
    }
...
export enum DMPNotFoundErrorErrorCodeEnum {
    DmpNotFound = 'dmp_not_found'
}
