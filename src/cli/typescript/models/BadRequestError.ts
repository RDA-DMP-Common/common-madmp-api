...
/**
* The passed HTTP request was invalid.
*/
/**
 ...
 * @export
 */
export type BadRequestError = DMPInvalidError | GenericBadRequestError | InvalidQueryStringError;

/**
* @type BadRequestErrorClass
    * The passed HTTP request was invalid.
* @export
*/
export class BadRequestErrorClass {
    static readonly discriminator: string | undefined = "errorCode";

    static readonly mapping: {[index: string]: string} | undefined = {
        "bad_request": "GenericBadRequestError",
        "invalid_dmp": "DMPInvalidError",
        "invalid_query_string": "InvalidQueryStringError",
    };
}
