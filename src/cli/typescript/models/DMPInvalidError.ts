...
*/
export class DMPInvalidError {
    'errorCode': DMPInvalidErrorErrorCodeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "DMPInvalidErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
    ...
    static getAttributeTypeMap() {
        return DMPInvalidError.attributeTypeMap;
    }
...
export enum DMPInvalidErrorErrorCodeEnum {
    DmpInvalid = 'dmp_invalid'
}
