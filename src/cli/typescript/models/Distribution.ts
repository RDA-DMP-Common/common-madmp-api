...
export class Distribution {
    ...
    */
    'accessUrl'?: string;
    /**
    * Indicates how long this distribution will be/ should be available. Encoded using the relevant ISO 8601 Date compliant string.
    */
