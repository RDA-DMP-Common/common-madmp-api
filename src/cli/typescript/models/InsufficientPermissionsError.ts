...
/**
* The current user has insufficient permissions to perform this action.
*/
export class InsufficientPermissionsError {
    'errorCode': InsufficientPermissionsErrorErrorCodeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "InsufficientPermissionsErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
    ...
    static getAttributeTypeMap() {
        return InsufficientPermissionsError.attributeTypeMap;
    }
...
export enum InsufficientPermissionsErrorErrorCodeEnum {
