...
/**
* The client has requested a DMP standard that the server cannot fulfill.
*/
export class NotAcceptableError {
    'errorCode': NotAcceptableErrorErrorCodeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "NotAcceptableErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
    ...
    static getAttributeTypeMap() {
        return NotAcceptableError.attributeTypeMap;
    }
...
export enum NotAcceptableErrorErrorCodeEnum {
