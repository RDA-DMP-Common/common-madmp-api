...
/**
* Authentication required to perform the specified request.
*/
export class AuthenticationRequiredError {
    'errorCode': AuthenticationRequiredErrorErrorCodeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "AuthenticationRequiredErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
    ...
    static getAttributeTypeMap() {
        return AuthenticationRequiredError.attributeTypeMap;
    }
...
export enum AuthenticationRequiredErrorErrorCodeEnum {
