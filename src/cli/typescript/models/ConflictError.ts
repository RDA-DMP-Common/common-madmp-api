...
/**
* The server failed to apply the patch because a JSON Patch test failed. If the patch applies successfully, but results in an invalid DMP, an DMPInvalidResponse (400) is returned instead. 
*/
export class ConflictError {
    'errorCode': ConflictErrorErrorCodeEnum;
    /**
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "ConflictErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
...
export enum ConflictErrorErrorCodeEnum {
    Conflict = 'conflict'
}
