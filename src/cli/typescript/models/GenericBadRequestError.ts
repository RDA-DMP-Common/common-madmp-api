...
*/
export class GenericBadRequestError {
    'errorCode': GenericBadRequestErrorErrorCodeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "errorCode",
            "baseName": "error_code",
            "type": "GenericBadRequestErrorErrorCodeEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
    ...
    static getAttributeTypeMap() {
        return GenericBadRequestError.attributeTypeMap;
    }
...
export enum GenericBadRequestErrorErrorCodeEnum {
