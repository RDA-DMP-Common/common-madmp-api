...
// Additional option specific to middlewares merge strategy
...
export interface ConfigurationParameters {
     ...
     * add any number of middlewares components to modify requests before they
     * are sent or before they are deserialized by implementing the `Middleware`
     * interface defined in `./middlewares`
     */
    middleware?: Middleware[];
    /**
     * Configures middlewares functions that return promises instead of
     * Observables (which are used by `middlewares`). Otherwise allows for the
     * same functionality as `middlewares`, i.e., modifying requests before they
