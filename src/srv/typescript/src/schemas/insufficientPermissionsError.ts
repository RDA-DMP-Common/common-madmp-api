...
import type { InsufficientPermissionsErrorAllOf } from './insufficientPermissionsErrorAllOf';

/**
 * The current user has insufficient permissions to perform this action.
 */
export type InsufficientPermissionsError = Error & InsufficientPermissionsErrorAllOf;
