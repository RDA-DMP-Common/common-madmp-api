 ...
 */
import type { InsufficientPermissionsError } from './insufficientPermissionsError';
 ...
 */
export type InsufficientPermissionsResponseResponse = InsufficientPermissionsError;
