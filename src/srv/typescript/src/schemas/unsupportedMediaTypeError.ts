...
import type { UnsupportedMediaTypeErrorAllOf } from './unsupportedMediaTypeErrorAllOf';

/**
 * The server cannot process the DMP sent by the client because it does not support th especified MIME type.
 */
export type UnsupportedMediaTypeError = Error & UnsupportedMediaTypeErrorAllOf;
