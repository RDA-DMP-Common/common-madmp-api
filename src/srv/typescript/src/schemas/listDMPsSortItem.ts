...
export type ListDMPsSortItem = typeof ListDMPsSortItem[keyof typeof ListDMPsSortItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListDMPsSortItem = {
  'title,asc': 'title,asc',
  ...
  'embargo,asc': 'embargo,asc',
  'embargo,desc': 'embargo,desc',
  'keyword,asc': 'keyword,asc',
