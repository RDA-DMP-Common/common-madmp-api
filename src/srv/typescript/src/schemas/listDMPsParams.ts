 ...
 */
import type { ListDMPsSortItem } from './listDMPsSortItem';
import type { LanguageID } from './languageID';
import type { ContactIDValue } from './contactIDValue';
import type { ContributorIDValue } from './contributorIDValue';
import type { DatasetIDValue } from './datasetIDValue';
import type { MetadataStandardIDValue } from './metadataStandardIDValue';
import type { DMPIDValue } from './dMPIDValue';
import type { FunderIDValue } from './funderIDValue';
import type { GrantIDValue } from './grantIDValue';

export type ListDMPsParams = {
/**
 ...
 */
'sort[]'?: ListDMPsSortItem[];
created_before?: string;
created_after?: string;
modified_before?: string;
modified_after?: string;
'languages[]'?: LanguageID[];
'contact_ids[]'?: ContactIDValue[];
'contributor_ids[]'?: ContributorIDValue[];
'dataset_ids[]'?: DatasetIDValue[];
'metadata_standard_ids[]'?: MetadataStandardIDValue[];
'dmp_ids[]'?: DMPIDValue[];
'funder_ids[]'?: FunderIDValue[];
'grant_ids[]'?: GrantIDValue[];
query?: string;
