 ...
 */
import type { DMPSystemID } from './dMPSystemID';

export type DMPWithIDAllOf = {
  /** A system-dependent identifier for this DMP. The identifier is not valid outside of the current API, use the dmpId field in the DMP object itself it you need a system-independent identifier. */
  id: DMPSystemID;
};
