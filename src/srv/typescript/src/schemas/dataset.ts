...
import type { DatasetLanguage } from './datasetLanguage';
import type { Metadata } from './metadata';
import type { DatasetPersonalData } from './datasetPersonalData';
import type { SecurityAndPrivacyItems } from './securityAndPrivacyItems';
import type { DatasetSensitiveData } from './datasetSensitiveData';
import type { TechnicalResources } from './technicalResources';
...
export interface Dataset {
  ...
  personal_data: DatasetPersonalData;
  /** Preservation Statement */
  preservation_statement?: string;
  security_and_privacy?: SecurityAndPrivacyItems;
  /** If any sensitive data is contained. Allowed values: yes, no, unknown */
  sensitive_data: DatasetSensitiveData;
  technical_resource?: TechnicalResources;
