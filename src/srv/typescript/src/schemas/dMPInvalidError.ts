...
import type { DMPInvalidErrorAllOf } from './dMPInvalidErrorAllOf';
import type { DMPInvalidErrorErrorCode } from './dMPInvalidErrorErrorCode';

/**
 * The passed DMP was invalid
 */
export type DMPInvalidError = Error & DMPInvalidErrorAllOf & {
  error_code: DMPInvalidErrorErrorCode;
};
