...
import type { InvalidQueryStringErrorAllOf } from './invalidQueryStringErrorAllOf';
import type { InvalidQueryStringErrorErrorCode } from './invalidQueryStringErrorErrorCode';

/**
 * The passed query string for a list request was invalid.

 */
export type InvalidQueryStringError = Error & InvalidQueryStringErrorAllOf & {
  error_code: InvalidQueryStringErrorErrorCode;
};
