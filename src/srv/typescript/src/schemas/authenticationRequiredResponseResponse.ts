 ...
 */
import type { AuthenticationRequiredError } from './authenticationRequiredError';
 ...
 */
export type AuthenticationRequiredResponseResponse = AuthenticationRequiredError;
