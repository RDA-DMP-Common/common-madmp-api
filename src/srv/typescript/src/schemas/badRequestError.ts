 ...
 */
import type { InvalidQueryStringError } from './invalidQueryStringError';
import type { DMPInvalidError } from './dMPInvalidError';
import type { GenericBadRequestError } from './genericBadRequestError';

/**
 * The passed HTTP request was invalid.
 */
export type BadRequestError = InvalidQueryStringError | DMPInvalidError | GenericBadRequestError;
