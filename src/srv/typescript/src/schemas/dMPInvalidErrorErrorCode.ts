...
export type DMPInvalidErrorErrorCode = typeof DMPInvalidErrorErrorCode[keyof typeof DMPInvalidErrorErrorCode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DMPInvalidErrorErrorCode = {
  invalid_dmp: 'invalid_dmp',
} as const;
