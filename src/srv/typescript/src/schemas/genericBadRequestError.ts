...
import type { GenericBadRequestErrorAllOf } from './genericBadRequestErrorAllOf';
import type { GenericBadRequestErrorErrorCode } from './genericBadRequestErrorErrorCode';

/**
 * The request the client sent is invalid.
 */
export type GenericBadRequestError = Error & GenericBadRequestErrorAllOf & {
  error_code: GenericBadRequestErrorErrorCode;
};
