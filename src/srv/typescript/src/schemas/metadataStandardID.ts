...
import type { MetadataStandardIDType } from './metadataStandardIDType';

export interface MetadataStandardID {
  identifier: MetadataStandardIDValue;
  type: MetadataStandardIDType;
}
