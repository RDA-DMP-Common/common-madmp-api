...
import type { AuthenticationRequiredErrorAllOf } from './authenticationRequiredErrorAllOf';

/**
 * Authentication required to perform the specified request.
 */
export type AuthenticationRequiredError = Error & AuthenticationRequiredErrorAllOf;
